...
${PURCHASE_PRICE}
${BALANCE}
${portfolio_url}   https://staging.binary.com/en/user/portfoliows.html
...
Check Portfolio Page
    ...
    sleep  5
    #open different tab for portfolio page
    execute javascript      window.open('${portfolio_url}', '_blank');
    Select Window   MAIN
    sleep  5
    buy a contract
    Select Window   url=${portfolio_url}
    verify the page is loaded successfuly
    verify recent bought contract added in portfolio page
    verify recent sold removed from portfolio page
